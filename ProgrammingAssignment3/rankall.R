rankall <- function(outcome, num = "best") {
      ...
      for (pradesh in st) {
            hospital_state <- hospital_perf[hospital_perf$State == pradesh, c(2, 7, 11, 17, 23)] 
            }
